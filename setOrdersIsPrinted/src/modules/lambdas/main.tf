...
resource "aws_lambda_function_url" "setIsPrintedLambda_eredis_url" {
  function_name      = aws_lambda_function.setIsPrintedLambda_eredis.function_name
  qualifier          = "setIsPrintedLambda_eredis"
  authorization_type = "AWS_IAM"
